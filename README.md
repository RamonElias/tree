...
- **Create a new database in postgresql or mysql called ' tree '**
- **Replace this environment vars in ./.env in your project according your
  credentials** DB_CONNECTION=pgsql ; DB_HOST=127.0.0.1 ; DB_PORT=5432 ;
  DB_DATABASE=tree ; DB_USERNAME=postgres ; DB_PASSWORD=123456
- **In your terminal call this command ' php artisan migrate:fresh --seed ' to
  seed tree data**
- **Hit this endpoint ' /api/documentation ' to see and tests the tree nodes
  endpoints in swagger**
- **Hit this endpoint ' /seeder ' to reset database data**
